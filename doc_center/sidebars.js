        ...
        'backend/README',
        {
          ...
          items: [
                ...
                'backend/spring/spring-cloud-gateway/compilation',
                {
                  ...
                  items: [
                    ...
                    'backend/spring/spring-cloud-gateway/study-note/spring-cloud-gateway-webflux',
                    {
                      ...
                      items: [
                        'backend/spring/spring-cloud-gateway/study-note/spring-cloud-gateway-server/README',
                        'backend/spring/spring-cloud-gateway/study-note/spring-cloud-gateway-server/actuate',
                        'backend/spring/spring-cloud-gateway/study-note/spring-cloud-gateway-server/config',
                      ],
                    },
                  ],
                },
            ...
            },
            {
              ...
              label: 'Spring Beans',
              items: [
                'backend/spring/spring-beans/AbstractBeanDefinition',
                'backend/spring/spring-beans/BeanDefinition',
                'backend/spring/spring-beans/BeanFactory',
                'backend/spring/spring-beans/BeanFactoryUtils',
                'backend/spring/spring-beans/BeanWrapper',
                'backend/spring/spring-beans/ConfigurableBeanFactory',
                'backend/spring/spring-beans/ListableBeanFactory',
                'backend/spring/spring-beans/PropertyEditorRegistry',
                'backend/spring/spring-beans/SingletonBeanRegistry',
                'backend/spring/spring-beans/TypeConverter',
              ],
            },
            {
              type: 'category',
              label: 'Spring Core',
              items: [
                'backend/spring/spring-core/README',
                'backend/spring/spring-core/Assert',
                'backend/spring/spring-core/CollectionUtils',
                'backend/spring/spring-core/ConversionService',
                'backend/spring/spring-core/ClassUtils',
                'backend/spring/spring-core/LogFormatUtils',
                'backend/spring/spring-core/NumberUtils',
                'backend/spring/spring-core/ObjectUtils',
                'backend/spring/spring-core/ParameterizedTypeReference',
                'backend/spring/spring-core/ResolvableType',
                'backend/spring/spring-core/ResourceUtils',
                'backend/spring/spring-core/StringUtils',
                'backend/spring/spring-core/TypeUtils',
              ],
            },
            {
              type: 'category',
              label: 'Spring Web',
              items: [
                'backend/spring/spring-web/HttpHeaders',
                'backend/spring/spring-web/ServerWebExchange',
                'backend/spring/spring-web/WebSession',
              ],
            },
            {
              type: 'category',
              ...
              items: [
                'backend/spring/spring-webflux/README',
                'backend/spring/spring-webflux/config',
              ],
            },
      ...
      items: [
        'programming-languages/README',
        {
          ...
          items: [
            ...
            'programming-languages/golang/effective-go',
            'programming-languages/golang/how-to-write-go-code',
            'programming-languages/golang/tutorial',
          ],
        },
        {
          type: 'category',
